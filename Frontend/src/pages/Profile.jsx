            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4">
                ...
                {!isEditing && (
                  <button
                    onClick={handleEdit}
                    className="px-6 py-3 cursor-pointer bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
                  >
                ...
                <div className="bg-gray-50 rounded-2xl p-6 sm:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-purple-600 cursor-pointer to-pink-600 text-white py-3 px-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {mutation.isPending ? (
                    ...
                    <button
                      ...
                      disabled={mutation.isPending}
                      className="flex-1 bg-gray-200 cursor-pointer text-gray-700 py-3 px-6 rounded-xl font-semibold hover:bg-gray-300 transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Cancel
                    </button>
                  </div>
